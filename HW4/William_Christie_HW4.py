...
#utilized Mark Amery's byteify function to convert Unicode to strings in JSON object.
def byteify(input):
...
#http://stackoverflow.com/questions/13921910/python-urllib2-receive-json-response-from-url used to open api url.
			response = urllib2.urlopen('http://api.openweathermap.org/data/2.5/weather?q=%s,%s&APPID=165737e69e4fce2a4c795218956af777' % (capital, state))
